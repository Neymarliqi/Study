...
<script>
	export default {
		...
		methods: {
			// textarea 输入内容获取，存到feedInfo的变量里面
			bindTextAreaInput(e) {
			...
			async sendFeed() {
					 ...
					 // 图片为空的时候需要上传
					  ...
					  // let res = this.$u.api.uploadFile(this.uploadPicsList)
					  // console.log("展示",res)
					  ...
					  console.log("循环后",this.uploadPicsList)
